...
| **Dos niveles** con agrupamiento: invariancia a posición y tamaño | V1→V2→IT | Invariancia a posición y tamaño hecha en el frente: la retina centra el contenido y, si es pequeño, lo **acerca** (una sacada y una mirada de cerca) hasta un tamaño fijo; la cruz a la mitad de tamaño en una esquina es la cruz. La corteza sigue siendo una capa sobre contraste centro-periferia con compromiso de los reclutados. Pendiente: la jerarquía de partes (hueco conocido: media figura recentrada no se reconoce como la figura) | Reconoce el mismo objeto desplazado y a otro tamaño |
